%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% FOR SNN TRAINING WITH SBP, Paralleling {Tasks, Models}
...
% Run these tasks with parpool
tasks = {{'mnist','differentialSTDP'},{'mnist','symmetricSTDP'},{'mnist','SBP'}, ...
    {'nettalk','differentialSTDP'},{'nettalk','symmetricSTDP'},{'nettalk','SBP'}, ...
    {'guesture','differentialSTDP'},{'guesture','symmetricSTDP'},{'guesture','SBP'}};

% tasks = {{'mnist','symmetricSTDP'},{'mnist','SP'},{'nettalk','symmetricSTDP'},{'nettalk','SP'},{'guesture','symmetricSTDP'},{'guesture','SP'}};
...
parfor ii = 1:length(tasks)
    ...
    fname_txt =['logs/log_', datestr1, '_', tasks{ii}{1},'_',tasks{ii}{2},'.txt'];
    fname_model = ['models/snn_' datestr1 '_' tasks{ii}{1} '_' tasks{ii}{2} '.mat'];
    fname_figpath = ['figures/' datestr1  '_' tasks{ii}{1} '_' tasks{ii}{2}  '/'];
    ...
    switch opts.task
        ...
        case 'guesture'
            ...
            opts.batchsize=50;
            data1 = load('DVS_gesture_100.mat'); % codes in guesture folder
    ...
    opts.stdp_type = tasks{ii}{2};% differentialSTDP,symmetricSTDP, postdiffSTDP, SP
